...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async (response: CredentialResponse) => {
    ...
    try {
      const user = await socialLogin('google', { credential: response.credential });
          ...
          <div className="flex-1 flex flex-col justify-center px-8 lg:px-12 xl:px-16 pb-6">
            ...
            <div className="mt-5">
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="flex h-11 items-center justify-center overflow-hidden rounded-xl bg-white">
                  <GoogleLogin
