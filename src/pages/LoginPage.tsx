          ...
          <div className="flex-1 flex flex-col justify-center px-8 lg:px-12 xl:px-16 pb-6">
            ...
            <div className="mt-5">
              ...
              <div className="grid grid-cols-3 gap-3">
                <button type="button" onClick={() => googleLogin()} className="flex items-center justify-center gap-2 h-11 rounded-xl border border-gray-200 bg-white hover:border-gray-300 hover:shadow-sm transition-all text-sm font-semibold text-gray-700">
